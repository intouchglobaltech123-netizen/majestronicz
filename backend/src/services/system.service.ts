...
export async function getBootstrap() {
  const [
    ...
    purchaseOrders, employees, attendanceRecords, payrollRecords, customers, stockTransfers, payments, configRows,
  ] = await Promise.all([
    ...
    prisma.customer.findMany(), prisma.stockTransfer.findMany(), prisma.payment.findMany(), prisma.appConfig.findMany(),
  ]);
