      ...
      <div className="bg-white border border-slate-200 rounded-2xl w-full max-w-2xl shadow-2xl overflow-hidden flex flex-col text-slate-900">
        ...
        <div className="p-5 border-b border-slate-200 flex items-center justify-between bg-slate-50">
          <div className="flex items-center gap-3">
            <div className="h-10 w-10 rounded-xl bg-blue-100 border border-blue-200 flex items-center justify-center text-blue-700">
            ...
            {BRANCHES.map((b) => {
              ...
              return (
                <div
                  key={b.id}
                  className={cn(
                    'rounded-xl border p-4 flex flex-col transition-all relative',
                    isSelected
