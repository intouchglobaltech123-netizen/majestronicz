                            ...
                            >
                              <div className="flex items-start justify-between gap-2">
                                ...
                                <button
                                  ...
                                  className="px-2 py-1 bg-slate-800 hover:bg-slate-900 text-white rounded-none text-[11px] font-bold transition-colors shrink-0 shadow-2xs flex items-center gap-1 border border-slate-700 cursor-pointer"
                                >
                                  <span>Register</span>
                    ...
                    {stockArrivedOrders.length > 0 && (
                      <div className="p-2 bg-emerald-50/40">
                        ...
                        {stockArrivedOrders.map((po) => (
                          <div
                            key={po.id}
                            className="p-2.5 rounded-none bg-white border border-emerald-200 shadow-2xs hover:shadow-xs transition-all mt-1"
                          >
                            <div className="flex items-start justify-between gap-2">
                              <div>
                              ...
                              <button
                                ...
                                className="px-2 py-1 bg-emerald-600 hover:bg-emerald-700 text-white rounded-none text-[11px] font-bold transition-colors shrink-0 shadow-2xs flex items-center gap-1 border border-emerald-700 cursor-pointer"
                              >
                        ...
                        {dueReminders.map((rem) => {
                          ...
                          return (
                            <div
                              key={rem.id}
                              className={cn(
                                'p-2.5 rounded-none border shadow-2xs transition-all mt-1.5',
                                isOverdue
                            ...
                            >
                              <div className="flex items-start justify-between gap-2">
                                <div className="space-y-1 min-w-0">
                                  <div className="flex items-center gap-1.5 flex-wrap">
                                    <span className="font-mono font-bold text-[11px] text-red-700 bg-red-50 px-1.5 py-0.2 rounded-none border border-red-200">
                                      {rem.enquiryNumber}
                                    </span>
                                    <span
                                      className={cn(
                                        'text-[10px] font-bold px-1.5 py-0.2 rounded-none uppercase',
                                        isOverdue
                                          ? 'bg-rose-100 text-rose-700 border border-rose-300'
                                  ...
                                  {rem.notes && (
                                    <p className="text-[11px] text-slate-500 italic bg-white p-1.5 rounded-none border border-slate-200">
                                      "{rem.notes}"
                                    </p>
                                  )}
                                </div>
                              ...
                              <div className="mt-2.5 pt-2 border-t border-slate-200 flex items-center justify-between gap-2">
                                <button
                                  ...
                                  className="px-2.5 py-1 bg-red-600 hover:bg-red-700 text-white rounded-none text-[11px] font-bold transition-colors flex items-center gap-1 shadow-2xs border border-red-700 cursor-pointer"
                                >
                                ...
                                <button
                                  ...
                                  className="px-2.5 py-1 bg-white hover:bg-emerald-50 text-slate-700 hover:text-emerald-700 border border-slate-300 hover:border-emerald-300 rounded-none text-[11px] font-bold transition-colors flex items-center gap-1 cursor-pointer"
                                >
                          ...
                          >
                            <div className="flex items-center justify-between gap-2">
                              ...
                              <button
                                type="button"
                                onClick={() => handleOpenEnquiry(rem.enquiryId)}
                                className="p-1 rounded-none text-slate-400 hover:text-red-600 hover:bg-red-50 border border-transparent hover:border-red-200 transition-colors cursor-pointer"
                                title="Open Enquiry"
                              >
