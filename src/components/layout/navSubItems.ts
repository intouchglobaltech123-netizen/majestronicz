    ...
    subOptions: [
      {
        id: 'all',
        label: 'All Parties',
        description: 'Customers and supplier accounts',
        icon: Contact,
        tag: 'Filter',
      },
      {
        ...
        description: 'Receivables & unpaid dues',
        icon: UserCheck,
        tag: 'Filter',
      },
      {
        ...
        description: 'Procurement payables',
        icon: Building2,
        tag: 'Filter',
      },
    ],
    ...
    subOptions: [
      {
        id: 'ALL',
        label: 'All Orders',
        description: 'Full order pipeline',
        icon: Clock,
        tag: 'Filter',
      },
      {
        id: 'Draft',
        label: 'Draft Orders',
        description: 'Unconfirmed customer orders',
        icon: FileText,
        tag: 'Filter',
      },
      {
        ...
        description: 'Ready for picking & packing',
        icon: PackageCheck,
        tag: 'Filter',
      },
      {
