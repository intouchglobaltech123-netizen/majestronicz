...
export const NAV_SUB_CONFIG: Record<ActiveNavView, NavItemSubConfig> = {
  ...
  shopify: {
    id: 'shopify',
    title: 'Online Store',
    subtitle: 'Shopify sync & e-commerce',
    icon: Store,
    accentColor: 'emerald',
    primaryAction: {
      id: 'orders',
    ...
    subOptions: [
      {
        ...
        description: 'Shopify orders, tracking & invoices',
        icon: ShoppingCart,
        tag: 'Tab',
      },
      {
        ...
        description: 'Reconcile ERP stock with Shopify',
        icon: Boxes,
        tag: 'Tab',
      },
      {
        ...
        description: 'Shopify variants & SKU mapping',
        icon: Package,
        tag: 'Tab',
      },
      {
        ...
        description: 'Web buyers, spend & ERP sync',
        icon: Users,
        tag: 'Tab',
      },
      {
        ...
        description: 'API credentials, branch & webhooks',
        icon: Settings,
        tag: 'Tab',
      },
    ],
